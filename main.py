...
def list_all_products(available_products):
    """
    This function will list all available products.
    """
    if not available_products:
        print("We are sold out. Try again later!")
        print()
        return
...
def order_products():
    ...
    while True:
        ...
        list_all_products(available_products)
        order_list = []
...
def handle_main_menu(user_input):
    ...
    """
    if user_input == 1:
        list_all_products(best_buy.get_all_products())
    elif user_input == 2:
        show_total_amount()
    elif user_input == 3:
        order_products()
